            ...
            <Card>
              ...
              <CardContent>
                <div className="flex flex-col items-center text-center space-y-4">
                  ...
                  <p className="text-lg italic">"Integrity first, service before self, excellence in all we do."</p>
                  <p className="text-sm text-muted-foreground">— USAFA Core Values</p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-3 rounded-lg border p-3 hover:bg-accent transition-colors">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <div className="text-sm text-muted-foreground">Track your academic progress</div>
                  </div>
                </div>
                <div className="flex items-center gap-3 rounded-lg border p-3 hover:bg-accent transition-colors">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#0033a0]">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <div className="text-sm text-muted-foreground">Prepare for the CFA</div>
                  </div>
                </div>
                <div className="flex items-center gap-3 rounded-lg border p-3 hover:bg-accent transition-colors">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#0033a0]">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <div className="text-sm text-muted-foreground">Define your objectives</div>
                  </div>
                </div>
              </CardContent>
              <CardFooter>
        ...
        <TabsContent value="goals" className="space-y-4">
          <Card>
            ...
            <CardContent className="flex flex-col items-center justify-center py-8 text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1">Define your goals to track your progress</p>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>United States Air Force Academy</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
              ...
              <CardFooter>
                <Button
                  variant="outline"
                  className="w-full"
                  onClick={() => window.open("https://www.usafa.edu/", "_blank")}
                >
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <div className="text-sm text-muted-foreground">Required from your representative</div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#0033a0]">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <div className="text-sm text-muted-foreground">Strong GPA and test scores</div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#0033a0]">
                  ...
                  <div className="space-y-0.5">
                    <div className="font-medium">Candidate Fitness Assessment</div>
                    <div className="text-sm text-muted-foreground">Physical fitness evaluation</div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#0033a0]">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <div className="text-sm text-muted-foreground">Demonstrated leadership abilities</div>
                  </div>
                </div>
              </CardContent>
              <CardFooter>
                <Button
                  variant="outline"
                  className="w-full"
                  onClick={() => window.open("https://www.usafa.edu/admissions/", "_blank")}
                >
