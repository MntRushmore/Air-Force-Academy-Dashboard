              ...
              <Command>
                ...
                <CommandList>
                  ...
                  <div className="flex items-center p-2 border-b">
                    <Button variant="ghost" size="sm" onClick={selectAllCourses} className="mr-2">
                      Select All
                    </Button>
                    <Button variant="ghost" size="sm" onClick={clearCourseSelection}>
                      Clear
                    </Button>
                  </div>
                  <CommandGroup>
                    {courses.map((course) => (
                      <CommandItem key={course.id} value={course.id} onSelect={() => toggleCourse(course.id || "")}>
                        <Check
                          className={cn(
                            "mr-2 h-4 w-4",
